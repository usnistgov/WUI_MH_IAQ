...
def create_scaled_comparison_chart(smps_data, script_metadata):
    ...
    if 'burn4' in smps_data:
        ...
        summary.append(f"04-House-1-N (Scaled): {scaled_cadr:.1f} ± {scaled_uncertainty:.1f} m³/h")
    ...
    if 'burn6' in smps_data:
        ...
        summary.append(f"{BURN_LABELS['burn6']}: {burn6_cadr:.1f} ± {burn6_uncertainty:.1f} m³/h")
...
def create_combined_comparison_chart(smps_data, script_metadata):
    ...
    if 'burn6' in smps_data:
        ...
        summary.append(f"1 Air Cleaner (Sealed Room): {cadr:.1f} ± {uncertainty:.1f} m³/h")
